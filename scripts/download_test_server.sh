...
out=$(download "https://search.maven.org/remotecontent?filepath=com/palantir/conjure/verification/${API}/${VERSION}/${ARTIFACT_NAME}")
cp -f "$out" "$DOWNLOAD_OUTPUT"

DOWNLOAD_OUTPUT="$RESOURCES_DIR/${TEST_CASES}.json"
ARTIFACT_NAME="${TEST_CASES}-${VERSION}.json"
out=$(download "https://search.maven.org/remotecontent?filepath=com/palantir/conjure/verification/${TEST_CASES}/${VERSION}/${ARTIFACT_NAME}")
cp -f "$out" "$DOWNLOAD_OUTPUT"
...
out=$(download "https://search.maven.org/remotecontent?filepath=com/palantir/conjure/verification/${SERVER}/${VERSION}/${ARTIFACT_NAME}")
